...
echo"<div class=table-responsive>
        <form name=maestro action='TestMaestro.php' method=Post>
...
/*echo "<br>".$maestro->createUsuario();
echo "<br>".$maestro->delete();
echo "<br>".$maestro->readEspecifico();
echo "<br>".$maestro->readGeneral();
echo "<br>".$maestro->update();*/
if(isset($_POST['submit'])){
    switch($_POST['submit']){
        case "Alta":
            echo"<div class='alert alert-danger' role='alert'>";
            echo"<br><strong>Datos del Maestro(a): ".($_POST['nombre']." ".$_POST['app']." ".$_POST['apm'])." guardados!!!</strong>";
            echo"</div>";
            $maestro->createUsuario("$_POST[nombre]","$_POST[app]","$_POST[apm]","$_POST[tel]","$_POST[calle]","$_POST[noext]","$_POST[noint]","$_POST[col]","$_POST[mun]","$_POST[edo]","$_POST[cp]","$_POST[mail]","$_POST[user]","$_POST[pass]","$_POST[nivel]");
            break;
       case "Borrar":
            echo"<div class='alert alert-info' role='alert'>";
            echo"<br>Se borraron los datos: ";
            echo"</div>";
            $maestro->delete("$_POST[idb]");
            break;
       case "Modificar":
           echo"<div class='alert alert-success' role='alert'>";
           echo"<br>Los datos se modificaron exitosamente: ";
           echo"</div>";
           $maestro->update("$_POST[idm]","$_POST[nombre]","$_POST[app]","$_POST[apm]","$_POST[nivel]");
           break;
       case "Buscar":
           ...
           echo"</div>";
           if("$_POST[idbb]"!=''){
           $maestro->readEspecifico("$_POST[idbb]");
           }
           else{
           $maestro->readGeneral();
           }
